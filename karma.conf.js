...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      // 3rd party libs
      { pattern: 'node_modules/ng2-completer/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/ng2-completer/**/*.js.map', included: false, watched: false },
      { pattern: 'node_modules/ng2-file-upload/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/ng2-file-upload/**/*.js.map', included: false, watched: false },
